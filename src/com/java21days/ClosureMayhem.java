...
public class ClosureMayhem extends JFrame {
    ...
    public ClosureMayhem() {
        ...
        ActionListener act = (event) -> {
            // coz actionListener only has one func: action performed
            // so it is capable to use lamda func to simplify
            // there's only one parameter : ActionEvent, so we can get rid of the class name
